const Navbar = function () {
    ...
    <nav class="component navbar h-padding v-padding">
        ...
        <div id="right">
            <ul id="navigations">
                <li class="navigation cursor-pointer"><a href="#">Home</a></li>
                <li class="navigation cursor-pointer"><a href="#">Features</a></li>
                <li class="navigation cursor-pointer"><a href="#">Community</a></li>
                <li class="navigation cursor-pointer"><a href="#">Blog</a></li>
                <li class="navigation cursor-pointer"><a href="#">Pricing</a></li>
            </ul>
            <button>
                Register Now
            </button>
